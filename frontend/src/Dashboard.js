...
function DashboardContent({count1,history}) {
  ...
  return (
    <ThemeProvider theme={mdTheme}>
        ...
        <AppBar position="absolute" open={open} color="inherit"  >
          ...
          >
            ...
            <div className="">
              ...
              <img src="/artBoard1.png" className="absolute top-0 w-24 p-0 bg-white border-8 border-white border-solid rounded-full drop-shadow-lg right-[44%] " />
              </div>
      ...
      >
        <MenuItem>
          <Avatar/> {user ?  user.email.slice(0,4).toUpperCase():"Profile"}
        </MenuItem>
        <MenuItem>
          <Avatar /> My Activity
        </MenuItem>
        ...
        >
          ...
          <div className="flex flex-col items-center box-0 md:h-40 md:flex-row bg-inherit">
...
export default function Dashboard() {
  return <DashboardContent  count1={Admin} />;
}

...
import DialogClass from "../Conpo/dailogClass";
import AddClassForm from "../Conpo/AddClassForm";
import AddClassAction from "../Conpo/AddClassAction";
...
const columns = [
    ...
    },
    {
      ...
      width: 120,
      renderCell:() =>[
        <DialogClass icons={<EditIcon color="" />}/>,
    ...
    },
    {
      ...
      width: 120,
      renderCell:() =>[
        <DialogClass icons={<DeleteIcon color="red" />}/>,
    ...
    },
    {
      ...
      width: 120,
      renderCell:() =>[
        <DialogClass icons={<RemoveRedEyeIcon color="blue" />}/>,
      ...
      >
        ...
        <div className="flex flex-col justify-center w-64 h-32 p-5 m-1 text-center bg-white box-4 ring-gray-100 rounded-xl">
          ...
          >
            ...
            <DialogClass  title={"Add New Class"} ContectD={<AddClassForm/>} ActionD={<AddClassAction/>} icons={<AddCircleIcon className="text-blue-500 " fontSize='large' />} />
            </div>
            <DataGrid
              rows={rows}
              columns={columns}
...
export default function DashClasses({history}) {
  return <DashboardContent history={history}  />;
}

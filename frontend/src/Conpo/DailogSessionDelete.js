...
import { getSess, sessionDelete } from "./../actions/userAction";
...
export default function DailogSessionDelete({ContectD,title,icons,id}) {
...
//   const id = "63259dd1e7917fdf0a6901d3"
  ...
  const { error, message } = useSelector((state) => state.deleteSession);

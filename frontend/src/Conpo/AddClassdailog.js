...
import { createClass, getClasses} from "./../actions/userAction";
...
export default function AddClassdailog({
  title,
  icons,
}) {
  ...
  const [civilAFFee, setCivilAFFee] = useState("");
  const [civilAFee, setCivilAFee] = useState("");
  ...
  const [policeAFFee, setPoliceAFFee] = useState("");
  const [section, setSection] = useState("");
  const [policeAFee, setPoliceAFee] = useState("");
  ...
  const handleCreate = async (e) => {
    ...
    myForm.set("CAFFee", civilAFFee);
    myForm.set("CAfee", civilAFee);
    myForm.set("PAnnualFees", policeannualFee);
    myForm.set("PMTfee", policeMFee);
    myForm.set("PExamFee", policeEFee);
    myForm.set("PAFFee", policeAFFee);
    myForm.set("PAfee", policeAFee);
            ...
            <Grid container spacing={3} marginBottom={3}>
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  value={civilAFFee}
                  fullWidth
                  onChange={(e) => setCivilAFFee(e.target.value)}
                  variant="standard"
                />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  value={civilAFee}
                  fullWidth
                  onChange={(e) => setCivilAFee(e.target.value)}
                  variant="standard"
                />
              </Grid>
            </Grid>
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  label="Admission Form Fee"
                  fullWidth
                  onChange={(e) => setPoliceAFFee(e.target.value)}
                  variant="standard"
                />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  value={policeAFee}
                  fullWidth
                  onChange={(e) => setPoliceAFee(e.target.value)}
                  variant="standard"
                />
              </Grid>
            </Grid>

...
import { getClasses, classDelete } from "./../actions/userAction";
...
export default function DailogClassDelete({ContectD,title,icons,id,sY}) {
...
//   const id = "63259dd1e7917fdf0a6901d3"
  ...
  const { error, message } = useSelector((state) => state.deleteClass);
  ...
  return (
    <div>
      <Button  variant="outlined" color='warning'  onClick={(e)=>{handleClickOpen(e)}}>
        {icons}
      </Button>
      <Dialog
        open={open}
